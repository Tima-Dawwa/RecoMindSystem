...
const { register, login, forgotPassword, resetPassword, confirmEmail, logout, resendCode } = require('./auth.controller');
...
authRouter.post('/resend-code', asyncHandler(resendCode));
